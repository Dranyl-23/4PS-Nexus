...
export const networks = {
  testnet: {
    ...
    contractId: "CBB2XYTBL7L3NUGORV6LMSAABHPVLST3ADVIKB4J66GSC47FPO3FJTWA",
  }
} as const
...
export const Errors = {
   ...
   */
  9: {message:"InsufficientVaultLiquidity"}
}

/**
 * The `DataKey` enum defines the storage keys used in the Soroban environment.
 */
export type DataKey = {tag: "Admin", values: void} | {tag: "Token", values: void} | {tag: "Merchant", values: readonly [string]} | {tag: "Allocation", values: readonly [string, Category]} | {tag: "Frozen", values: readonly [string]} | {tag: "TotalAllocated", values: void};
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "",
        ...
        "",
